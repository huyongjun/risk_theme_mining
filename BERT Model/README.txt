##### Task Description #####
This model is modified based on the open source Bert model, 
which mainly realizes the downstream task of emotion three classification and prediction.
...
----Pre-training Model----
To use this model, you need to download the Chinese pre-training model from Google firstly . 
The author uses the "chinese_l-12_h-768_a-12" version.

----fine-tuning----
You need to fine tune the hyperparameters, such as epoch, batch sizes and learning rates, 
to achieve the optimal accuracy of the model.

----Output----
***** Eval results *****
  eval_accuracy = xxxxxx
  eval_loss = xxxxxx
  global_step = xxxxxx
  loss = xxxxxx
...
##### Data description #####
The data is tagged Chinese Sina Weibo comment data.
